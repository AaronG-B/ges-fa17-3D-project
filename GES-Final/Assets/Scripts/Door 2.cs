...
public class Door2 : MonoBehaviour, IActivatable
{
    [SerializeField]
    string nameText;
    ...
    InventoryObject key;
    [SerializeField]
    InventoryObject key2;
    [SerializeField]
    InventoryObject key3;
    ...
    private bool HasKey
    {
        get
        {
            return playerInventory.Contains(key) && playerInventory.Contains(key2) && playerInventory.Contains(key3);
        }
    }
